    ...
    <div className="flex flex-col items-center sm:items-start w-full sm:w-auto">
      ...
      >
        <span className="relative z-10 flex items-center justify-center text-center gap-2 text-[#1A365D]">
          <span>Get Your Free 60-Second Video Audit</span>
          <svg className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 transition-transform duration-300 group-hover:translate-y-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path></svg>
        </span>
