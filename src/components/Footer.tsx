          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-col gap-6 items-center md:items-start">
              <div className="flex items-center justify-center md:justify-start gap-6 mt-2">
                ...
                <Link href="https://www.youtube.com/@multiprodigitalagency" className="text-blue-200/60 hover:text-brand-lime transition-all duration-300 hover:scale-110" target="_blank" rel="noopener noreferrer">
                ...
                <Link href="https://www.facebook.com/multiprodigitalagency" className="text-blue-200/60 hover:text-brand-lime transition-all duration-300 hover:scale-110" target="_blank" rel="noopener noreferrer">
