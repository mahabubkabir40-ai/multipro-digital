...
export default function OrlandoLocationPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            <nav className="flex items-center gap-2 text-brand-lime/80 text-sm font-black uppercase tracking-widest mb-8">
              <Link href="/" prefetch={false} className="hover:text-brand-lime">Home</Link>
              <ChevronRight className="w-4 h-4" />
              <Link href="/service-areas" prefetch={false} className="text-white hover:text-brand-lime">Service Areas</Link>
              <ChevronRight className="w-4 h-4" />
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 p-6 rounded-2xl bg-[#0f172a]/50 backdrop-blur-sm border border-white/10 w-fit shadow-2xl">
              <div className="flex -space-x-4">
                {[
                  { src: "/avatars/Adrian-owner-v2.jpg.webp", alt: "Adrian - Moving Company Partner" },
                  { src: "/avatars/David-Owner-v2.jpg.webp", alt: "David - 7-Figure Moving Business Owner" },
                  { src: "/avatars/Garret-owner-v2.jpg.webp", alt: "Garret - Professional Mover Marketing Client" },
                  { src: "/avatars/Mountain%20Movers.webp", alt: "Mountain Movers Orlando - Logo" },
                  { src: "/avatars/Sunshine%20Movers.webp", alt: "Sunshine Movers Florida - Logo" }
                ].map((avatar, index) => (
      ...
      {/* Optimized Container for below-the-fold content */}
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative">
                <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl border-8 border-slate-900/5 aspect-[4/5] lg:aspect-auto lg:h-[600px]">
                  <Image 
                    src="/images/orlando-maps-mockup.webp" 
